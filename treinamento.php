...
<link rel="canonical" href="https://gambeti.com.br/treinamento/<?=$url?>">	
...
<div class="tituloform">
	Precisa de <strong><?=$titulo?></strong> para sua equipe?<br>
	Solicite agora um <strong>orçamento</strong> de forma rápida, deixe os dados da sua empresa abaixo.
</div>
<?php
...
<form action="/solicitarligacao" method="post">
	...
	<input type="text" name="cargo" id="cargo" class="configcampoformligacao" placeholder="Preencha seu cargo">
	...
	<input type="text" name="cnpj" id="cnpj" class="configcampoformligacao" placeholder="Preencha o CNPJ da empresa">
