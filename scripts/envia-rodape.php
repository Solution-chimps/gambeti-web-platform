...
$corpo_email="
<font color='#000' face='arial'>Solicitação de contato pelo rodapé.<br />
<br />
<b>Nome:</b> $nome<br />
<b>Telefone:</b> $telefone<br />
<b>Mensagem:</b> $txtarea<br />
";
...
$assunto = "Contato Rodapé Site - $nome"; 
...
if($email_php==true){
	echo"<script>window.location='/obrigado?ref=contatorodape';</script>";
}
else{
	echo"
		<script>
