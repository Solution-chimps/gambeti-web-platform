...
<div class="tituloform">
	Precisa de um orçamento? Deixe seus dados que nossa equipe entra em contato.
</div>
<?php
    $urlatual= "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
?>			
<form action="/solicitarligacao7" method="post">
