...
?>
				...
				<div id="btbusca" onClick="buscar()"><img src="/default/btbusca.png" border="0" alt="Botão Buscar"></div> 
			</form>
		</div>
		...
		<div id="areaiconetelefones">
				<img src="/default/iconetelefone.png" alt="absmiddle">
			</div>	
		</div>		
</div>
<div id="areamenu">
	<div id="arealogo"><a href="/"><img src="/default/logohorizontal.png" alt="Logo Gambeti" border="0"></a></div>
	<div id="menu">
