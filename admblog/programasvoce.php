...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Programas > Para Você<br /><font size="2">&nbsp;&nbsp;&nbsp;Gerencie os programas Para Você.</font></div>
        Lista de Programas
        <br /><br /><br />
...
<table width="96%" border="0" cellpadding="0" cellspacing="0">
    <?php
		/*if($perfilUsuario!="1"){
			...
			echo"<td align=\"right\"><div style=\"width:150px\" class=\"btlaranja\" onclick=\"window.location='adicionar-programa.php';\">Adicionar Programa</div></td>";
		//}
	?>
...
?>           
        	...
        	<form action="programasvoce.php" method="get">
        	<div id="caixabusca">
            	<div id="btbusca"></div>
...
if(($palavra=="")&&($dtinicio!="")){
	...
	$contador="0";
	$consulta= "SELECT *FROM programasvoce$busca ORDER BY id ASC LIMIT $inicio,$qpp";
...
echo"
	<tr class=\"linhacomumpar\">
		...
		<td class=\"celularcomum\" align=\"center\" valign=\"middle\" style=\"border-right:none;\" width=\"140\">$btstatus<div class=\"btcinza\" onclick=\"window.location='editar-programa.php?id=$id';\">Editar</div></td>
    </tr>
";			
		}
		else{
...
//prepara o rodape
	...
	$consulta = mysql_query("SELECT COUNT(*) AS total FROM programasvoce$busca");
...
//verifica total de anuncios na consulta solicitada
   $result = mysql_query("SELECT COUNT(*) as Regs FROM programasvoce$busca");
...
<script>
	...
	function dlbanner(id){
		...
		if (answer){
			window.location = "scripts/dlprograma.php?id="+id;
		}
		else{
		}
	}	
