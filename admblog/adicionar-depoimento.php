...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Adicionar Depoimento<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e adicione esse depoimento.</font></div>
        <br />
		<br />
        <form action="scripts/cad-depoimento.php" method="post" enctype="multipart/form-data">
        ...
        Depoimento<br />
		<textarea name="depoimento" value="" class="configtexto"></textarea><br /><br />                  
