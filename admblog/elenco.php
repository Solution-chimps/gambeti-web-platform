...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Equipe<br /><font size="2">&nbsp;&nbsp;&nbsp;Gerencie a equipe no site.</font></div>
        Lista de Equipe
        <br /><br /><br />
...
<table width="96%" border="0" cellpadding="0" cellspacing="0">
    <?php
		/*if($perfilUsuario!="1"){
			...
			echo"<td align=\"right\"><div style=\"width:150px\" class=\"btlaranja\" onclick=\"window.location='adicionar-elenco.php';\">Adicionar Equipe</div></td>";
		//}
	?>
...
if(($palavra=="")&&($dtinicio!="")){
	...
	$contador="0";
	$consulta= "SELECT *FROM elenco$busca ORDER BY id ASC LIMIT $inicio,$qpp";
...
echo"
	<tr class=\"linhacomumpar\">
		...
		<td class=\"celularcomum\" align=\"center\" valign=\"middle\" style=\"border-right:none;\" width=\"140\">$btstatus<div class=\"btcinza\" onclick=\"window.location='editar-elenco.php?id=$id';\">Editar</div></td>
    </tr>
";			
		}
		else{
...
echo"
	<tr>
		<td colspan=\"5\" align=\"center\">Nenhum elenco encontrado... Cadastre no botão acima.</td>
	</tr>
";
	}
	else{
...
//prepara o rodape
	...
	$consulta = mysql_query("SELECT COUNT(*) AS total FROM elenco$busca");
...
//verifica total de anuncios na consulta solicitada
   $result = mysql_query("SELECT COUNT(*) as Regs FROM elenco$busca");
