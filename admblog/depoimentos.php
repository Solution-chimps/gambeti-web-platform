...
<body>
	...
	<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td align="left" valign="top" id="linhaconteudo">
				<div id="chamadapagina"><br />&nbsp;&nbsp;Depoimentos<br />
					<font size="2">&nbsp;&nbsp;&nbsp;Gerencie os depoimentos no site.</font>
				</div>
				...
				<table width="96%" border="0" cellpadding="0" cellspacing="0">
					...
					echo "<td align=\"right\"><div style=\"width:150px\" class=\"btlaranja\" onclick=\"window.location='adicionar-depoimento.php';\">Adicionar Depoimento</div></td>";
					//}
					?>
					...
					<tr>
						<td align="right" height="40">
							...
							<form action="depoimentos.php" method="get">
								<div id="caixabusca">
									<div id="btbusca"></div>
				...
				<table class="tabelalistagem" width="96%" cellpadding="8" cellspacing="0" border="0">
					...
					<tr class="linhaindice">
						...
						<td class="celularindice" align="center" valign="middle">Depoimento</td>
					...
					if ($palavra != "") {
						$busca = " WHERE nome REGEXP '$palavra' OR empresa REGEXP '$palavra'";
					}
					...
					$contador = "0";
					$consulta = "SELECT *FROM depoimentos$busca ORDER BY id ASC LIMIT $inicio,$qpp";
	...
	<tr class=\"linhacomumpar\">
    	...
    	<td class=\"celularcomum\" align=\"center\" valign=\"middle\">$depoimento</td>				
		<td class=\"celularcomum\" align=\"center\" valign=\"middle\" style=\"border-right:none;\" width=\"140\">$btstatus<div class=\"btcinza\" onclick=\"window.location='editar-depoimento.php?id=$id';\">Editar</div></td>
    </tr>
";
						} else {
							echo "
...
";
				...
				<table align="right" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td align="right">
							...
							$consulta = $mysqli->query("SELECT COUNT(*) AS total FROM depoimentos$busca");
							$mostrarTotal = $consulta->fetch_array();
							...
							$result = $mysqlo->query("SELECT COUNT(*) as Regs FROM depoimentos$busca");
	...
	<script>
		...
		function dlbanner(id) {
			var answer = confirm("Deseja mesmo deletar essas palavra?")
			if (answer) {
				window.location = "scripts/dldepoimento.php?id=" + id;
			} else {}
		}
	</script>
</body>
