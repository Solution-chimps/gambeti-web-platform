...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Vídeos<br /><font size="2">&nbsp;&nbsp;&nbsp;Gerencie os vídeos do site.</font></div>
        Lista de Vídeos
        <br /><br /><br />
...
<table width="96%" border="0" cellpadding="0" cellspacing="0">
    <?php
		/*if($perfilUsuario!="1"){
			...
			echo"<td align=\"right\"><div style=\"width:150px\" class=\"btlaranja\" onclick=\"window.location='adicionar-video.php';\">Adicionar Vídeo</div></td>";
		//}
	?>
...
<table class="tabelalistagem" width="96%" cellpadding="8" cellspacing="0" border="0">
	...
	<tr class="linhaindice">
    	<td class="celularindice" align="center" valign="middle">Data do Vídeo</td>
...
if(($palavra=="")&&($dtinicio!="")){
	...
	$contador="0";
	$consulta= "SELECT *FROM videos$busca ORDER BY id DESC LIMIT $inicio,$qpp";
...
echo"
	<tr class=\"linhacomumpar\">
		...
		<td class=\"celularcomum\" align=\"center\" valign=\"middle\" style=\"border-right:none;\" width=\"140\"><div class=\"btcinza\" onclick=\"deletar('$id');\">Deletar</div></td>
    </tr>
";	
...
echo"
	<tr>
		<td colspan=\"5\" align=\"center\">Nenhum vídeo encontrado... </td>
	</tr>
";
	}
	else{
...
<script>
	...
	function deletar(id){
		...
		if (answer){
			window.location = "scripts/dlvideo.php?id="+id;
		}
		else{
		}
	}	
