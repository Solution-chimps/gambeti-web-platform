<?php
	...
	$id=$_GET["id"];	
$consulta= "SELECT *FROM albuns WHERE id='$id'";
...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Editar <?=$nome?><br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e edite esse álbum.</font></div>
        <br />
		<br />
        <form action="scripts/edt-album.php?id=<?=$id?>" method="post">
<!--
        Destaque<br />
...
?>                                   
        ...
        Data do Evento<br />
		<input type="text" name="data" value="<?=$data?>" class="configcampo" /><br /><font size="1">dd/mm/aaaa</font><br /><br />
