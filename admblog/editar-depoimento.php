<?php
	...
	$id=$_GET["id"];	
$consulta= "SELECT *FROM depoimentos WHERE id='$id'";
...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Editar Depoimento<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e edite o depoimento.</font></div>
        <br />
		<br />
        <form action="scripts/edt-depoimento.php?id=<?=$id?>" method="post">
        ...
        Depoimento<br />
		<textarea name="depoimento" class="configtexto"><?=$depoimento?></textarea><br /><br />                  
