...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Adicionar Foto<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo fotos a esse álbum.</font></div>
        <br />
		<br />
        <form action="scripts/uploadMRelatorio.php?idalbum=<?=$idalbum?>" method="post" enctype="multipart/form-data">
        
        


        Foto<br />
		<input type='file' name='endereco[]' class="configcampo" multiple/><br />
<br />
...
<!--
        ...
        Descrição<br />
		<input type="text" name="descricao" value="" class="configcampo"><br /><br />  
