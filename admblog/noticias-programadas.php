...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Notícias Programadas<br /><font size="2">&nbsp;&nbsp;&nbsp;Gerenciamento das notícias programadas no site</font></div>
        Lista de Notícias Programadas<br />
        Hora do sistema: <?=$datasistema?> às <?=$horasistema?><br />
...
<?php
	...
	$fim=$_GET["from"];
?>           
        	<form action="noticias-programadas.php" method="get">
        	<div id="caixabusca">
            	<div id="btbusca"></div>
...
?>           
        	<form action="noticias-programadas.php" method="get" id="formfiltrardatas">
...
$ordenar=" ORDER BY id DESC";	
	...
	$contador="0";
	$consulta= "SELECT *FROM noticiasprog$busca$ordenar LIMIT $inicio,$qpp";
...
echo"
	<tr class=\"linhacomumpar\">
    	<td class=\"celularcomum\" align=\"center\" valign=\"middle\">$datatratada às $hora</td>
		...
		<td class=\"celularcomum\" align=\"center\" valign=\"middle\" style=\"border-right:none;\" nowrap=\"nowrap\">$btstatus<div class=\"btcinza\" onclick=\"window.location='editar-noticia-programada.php?id=$id';\">Editar</div></td>
    </tr>
";			
		}
		else{
...
echo"
	<tr>
		<td colspan=\"5\" align=\"center\">Nenhuma notícia programada.</td>
	</tr>
";
	}
	else{
...
<script>
	...
	function deletarnot(id){
		...
		if (answer){
			window.location = "scripts/dlnoticia-programada.php?id="+id;
		}
		else{
		}
	}	
