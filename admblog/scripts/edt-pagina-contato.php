<?php
	...
	$consultab="UPDATE paginas SET texto1='$texto1', texto2='$texto2', texto3='$texto3', texto4='$texto4', texto5='$texto5', texto6='$texto6', texto7='$texto7', texto8='$texto8' WHERE id='3'";
