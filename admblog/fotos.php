...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Fotos<br /><font size="2">&nbsp;&nbsp;&nbsp;Gerencie as galerias do site.</font></div>
        Lista de Galerias
        <br /><br /><br />
...
<table width="96%" border="0" cellpadding="0" cellspacing="0">
    <?php
		/*if($perfilUsuario!="1"){
			...
			echo"<td align=\"right\"><div style=\"width:150px\" class=\"btlaranja\" onclick=\"window.location='adicionar-album.php';\">Criar Galeria</div></td>";
		//}
	?>
...
<table class="tabelalistagem" width="96%" cellpadding="8" cellspacing="0" border="0">
	...
	<tr class="linhaindice">
    	<td class="celularindice" align="center" valign="middle">Data do Evento</td>
    	<td class="celularindice" align="center" valign="middle">Categoria</td>        
...
if(($palavra=="")&&($dtinicio!="")){
	...
	$contador="0";
	$consulta= "SELECT *FROM albuns$busca ORDER BY id DESC LIMIT $inicio,$qpp";
...
//verifco nome da categoria
	$consultax= "SELECT *FROM categorias WHERE id='$categoria'";
	$resultadox = mysql_query($consultax) or die("<br />Falha na execução da consulta CAT. Erro: ".mysql_error());
	if($linha=mysql_fetch_assoc($resultadox)){
		...
		$btedicao="<div class='btcinza' onclick=\"window.location='editar-fotos.php?idalbum=$id';\">Editar fotos</div>";


echo"
	<tr class=\"linhacomumpar\">

    	<td class=\"celularcomum\" align=\"center\" valign=\"middle\">$data</td>	
    	<td class=\"celularcomum\" align=\"center\" valign=\"middle\">$nomedacategoria</td>			
    	<td class=\"celularcomum\" align=\"center\" valign=\"middle\">$nome</td>					
		<td class=\"celularcomum\" align=\"center\" valign=\"middle\" style=\"border-right:none;\" width=\"140\"><div class=\"btcinza\" onclick=\"window.location='editar-album.php?id=$id';\">Editar</div><div class=\"btcinza\" onclick=\"deletar('$id');\">Deletar</div> $btedicao</td>
    </tr>
";	
...
echo"
	<tr>
		<td colspan=\"5\" align=\"center\">Nenhum álbum encontrado... Contate o administrador.</td>
	</tr>
";
	}
	else{
...
<script>
	...
	function deletar(id){
		var answer = confirm("Deseja mesmo deletar esse álbum?")
		if (answer){
			window.location = "scripts/dlalbum.php?id="+id;
		}
		else{
		}
	}	
