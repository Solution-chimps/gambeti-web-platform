...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Adicionar Vídeo<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e adicione um vídeo ao site.</font></div>
        <br />
		<br />
        <form action="scripts/cad-video.php" method="post" enctype="multipart/form-data">
		...
		<input type="text" name="nome" value="<?=$nome?>" class="configcampo" /><br /><br />
       	...
       	URL do Youtube<br />
		<input type="text" name="url" value="<?=$url?>" class="configcampo" /><br /><font size="1">Cole toda a URL. Exemplo: https://www.youtube.com/watch?v=fg8LDfpjsVg</font><br /><br />
