...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <br />
		<br />
        <form action="scripts/edt-programavoce.php?id=<?=$id?>" method="post">
		...
		<a href='#' onClick="window.open('verFotoPrograma.php?id=<?=$id?>','TrocarFoto','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=200,top=25,left=25'); return false;">alterar</a><br /><br />
