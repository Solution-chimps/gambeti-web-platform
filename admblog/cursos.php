...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Cursos<br /><font size="2">&nbsp;&nbsp;&nbsp;Gerencie os cursos a venda no site e a impressão dos certificados.</font></div>
        Lista de Cursos
        <br /><br /><br />
...
//prepara o rodape
	...
	$consulta = mysql_query("SELECT COUNT(*) AS total FROM cursos$busca");
...
//verifica total de anuncios na consulta solicitada
   $result = mysql_query("SELECT COUNT(*) as Regs FROM cursos$busca");
