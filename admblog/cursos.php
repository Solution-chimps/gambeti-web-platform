...
<body>
	...
	<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td align="left" valign="top" id="linhaconteudo">
				<div id="chamadapagina"><br />&nbsp;&nbsp;Cursos<br />
					<font size="2">&nbsp;&nbsp;&nbsp;Gerencie os cursos a venda no site e a impressão dos certificados.</font>
				</div>
				Lista de Cursos
				<br /><br /><br />
				...
				<table width="96%" border="0" cellpadding="0" cellspacing="0">
					...
					echo "<td align=\"right\"><div style=\"width:150px\" class=\"btlaranja\" onclick=\"window.location='adicionar-curso.php';\">Adicionar Curso</div></td>";
					//}
					?>
				...
				<table class="tabelalistagem" width="96%" cellpadding="8" cellspacing="0" border="0">
					...
					<tr class="linhaindice">
						...
						<td class="celularindice" align="center" valign="middle">Limite para Inscrição</td>
						<td class="celularindice" align="center" valign="middle">Expiração do Certificado</td>
					...
					if ($palavra != "") {
						$busca = " WHERE nome REGEXP '$palavra' OR nome REGEXP '$palavra'";
					}
					...
					$contador = "0";
					$consulta = "SELECT *FROM cursos$busca ORDER BY id ASC LIMIT $inicio,$qpp";

					//echo $consulta;

					$resultado = $mysqli->query($consulta) or die("<br />Falha na execução da consulta 2. Erro: " . $mysqli->error);
	...
	<tr class=\"linhacomumpar\">
    	...
    	<td class=\"celularcomum\" align=\"center\" valign=\"middle\">$datae</td>				
    	<td class=\"celularcomum\" align=\"center\" valign=\"middle\">$dtlimiteinscr</td>						
    	<td class=\"celularcomum\" align=\"center\" valign=\"middle\">$dtexpiracao</td>						
		<td class=\"celularcomum\" align=\"center\" valign=\"middle\" style=\"border-right:none;\" width=\"140\">$btstatus<div class=\"btcinza\" onclick=\"window.location='editar-curso.php?id=$id';\">Editar</div><div class=\"btcinza\" onclick=\"window.location='inscritos.php?palavra=$nome&to=&from=&qntpp=9999999999999';\">Inscritos</div></td>
    </tr>
";
						} else {
							echo "
	<tr class=\"linhacomumimpar\">
    	...
    	<td class=\"celularcomum\" align=\"center\" valign=\"middle\">$datae</td>				
    	<td class=\"celularcomum\" align=\"center\" valign=\"middle\">$dtlimiteinscr</td>						
    	<td class=\"celularcomum\" align=\"center\" valign=\"middle\">$dtexpiracao</td>						<td class=\"celularcomum\" align=\"center\" valign=\"middle\" style=\"border-right:none;\" width=\"140\">$btstatus<div class=\"btcinza\" onclick=\"window.location='editar-curso.php?id=$id';\">Editar</div><div class=\"btcinza\" onclick=\"window.location='inscritos.php?palavra=$nome&to=&from=&qntpp=9999999999999';\">Inscritos</div></td>
";
						}
					}
					...
					if ($contador == "0") {
						echo "
	<tr>
		<td colspan=\"5\" align=\"center\">Nenhum encontrado... Cadastre no botão acima.</td>
	</tr>
";
					} else {
...
";
				...
				<table align="right" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td align="right">
							...
							$consulta = $mysqli->query("SELECT COUNT(*) AS total FROM cursos$busca");
							...
							$result = $mysqli->query("SELECT COUNT(*) as Regs FROM cursos$busca");
	...
	<script>
		...
		function dlbanner(id) {
			var answer = confirm("Deseja mesmo deletar esse curso?\nAo excluir você irá deletar todos os inscritos nele.")
			if (answer) {
				window.location = "scripts/dlcurso.php?id=" + id;
			} else {}
		}
	</script>
</body>
