...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Fotos<br /><font size="2">&nbsp;&nbsp;&nbsp;Gerencie as fotos desse álbum.</font></div>
        Lista de Fotos
        <br /><br /><br />
<?php
...
//prepara o rodape
	...
	$consulta = mysql_query("SELECT COUNT(*) AS total FROM fotos$busca");
...
//verifica total de anuncios na consulta solicitada
   $result = mysql_query("SELECT COUNT(*) as Regs FROM fotos$busca");
