<?php
	...
	$id=$_GET["id"];	
$consulta= "SELECT *FROM paginas WHERE id='1'";
...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Editar Página Clínica<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e edite a página.</font></div>
        <br />
		<br />
        <form action="scripts/edt-pagina.php" method="post">
		...
		<a href='#' onClick="window.open('verFotoPG.php?id=<?=$id?>','TrocarFoto','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=200,top=25,left=25'); return false;">alterar</a><br /><br />
        
        Data<br />
        <input type="text" name="texto1" class="configcampo" value="<?=$texto1?>" /><br /><br />

        Horário<br />
        <input type="text" name="texto2" class="configcampo" value="<?=$texto2?>" /><br /><br />        

        Local<br />
        <input type="text" name="texto3" class="configcampo" value="<?=$texto3?>" /><br /><br />        


       Informações Gerais<br />
		<textarea name="texto4" class="configtexto"><?=$texto4?></textarea>  <br /><br />
