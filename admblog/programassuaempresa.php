...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Programas > Para Sua Empresa<br /><font size="2">&nbsp;&nbsp;&nbsp;Gerencie os programas Para Sua Empresa.</font></div>
        Lista de Programas
        <br /><br /><br />
...
<table width="96%" border="0" cellpadding="0" cellspacing="0">
    <?php
		/*if($perfilUsuario!="1"){
			...
			echo"<td align=\"right\"><div style=\"width:150px\" class=\"btlaranja\" onclick=\"window.location='adicionar-programa-suaempresa.php';\">Adicionar Programa</div></td>";
		//}
	?>
...
?>           
        	...
        	<form action="programassuaempresa.php" method="get">
        	<div id="caixabusca">
            	<div id="btbusca"></div>
...
<table class="tabelalistagem" width="96%" cellpadding="8" cellspacing="0" border="0">
	...
	<tr class="linhaindice">
    	<td class="celularindice" align="center" valign="middle">Imagem</td>
...
if(($palavra=="")&&($dtinicio!="")){
	...
	$contador="0";
	$consulta= "SELECT *FROM programassuaempresa$busca ORDER BY id ASC LIMIT $inicio,$qpp";
...
echo"
	<tr class=\"linhacomumpar\">
		...
		<td class=\"celularcomum\" align=\"center\" valign=\"middle\" style=\"border-right:none;\" width=\"140\">$btstatus<div class=\"btcinza\" onclick=\"window.location='editar-programasuaempresa.php?id=$id';\">Editar</div></td>
    </tr>
";			
		}
		else{
...
echo"
	<tr>
		<td colspan=\"5\" align=\"center\">Nenhum programa encontrado... Cadastre no botão acima.</td>
	</tr>
";
	}
	else{
...
//prepara o rodape
	...
	$consulta = mysql_query("SELECT COUNT(*) AS total FROM programassuaempresa$busca");
...
//verifica total de anuncios na consulta solicitada
   $result = mysql_query("SELECT COUNT(*) as Regs FROM programassuaempresa$busca");
...
<script>
	...
	function dlbanner(id){
		var answer = confirm("Deseja mesmo deletar esse programa?")
		if (answer){
			window.location = "scripts/dlprogramasuaempresa.php?id="+id;
		}
		else{
		}
	}	
