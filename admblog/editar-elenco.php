...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Editar Equipe<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e edite.</font></div>
        <br />
		<br />
        <form action="scripts/edt-elenco.php?id=<?=$id?>" method="post">
        ...
        Foto<br />
        <img src="../imagens/<?=$imagem?>" class="fotoprincipal" /><br /><font size="1">Dimensão ideal: 147px x 179px</font><br />
		<a href='#' onClick="window.open('verFotoElenco.php?id=<?=$id?>','TrocarFoto','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=200,top=25,left=25'); return false;">alterar</a><br /><br />
        ...
        Cargo<br />
		<input type="text" name="departamento" class="configcampo" value="<?=$departamento?>"><br /><br />  

        Contato<br />
		<input type="text" name="contato" class="configcampo" value="<?=$contato?>"><br /><br />  


        Sobre<br />
		<textarea name="sobre" class="configtexto"><?=$sobre?></textarea>  <br /><br />
        Missão<br />
		<textarea name="missao" class="configtexto"><?=$missao?></textarea>  <br /><br />
