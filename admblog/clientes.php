	...
	<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td align="left" valign="top" id="linhaconteudo">
				<div id="chamadapagina"><br />&nbsp;&nbsp;Clientes<br />
					<font size="2">&nbsp;&nbsp;&nbsp;Gerencie os clientes do site.</font>
				</div>
				Lista de Clientes
				<br /><br /><br />
...
";
					...
					if ($contador == "0") {
						echo "
	<tr>
		<td colspan=\"5\" align=\"center\">Nenhum cliente encontrado... Cadastre no botão acima.</td>
	</tr>
";
					} else {
				...
				<table align="right" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td align="right">
							...
							$consulta = $mysqli->query("SELECT COUNT(*) AS total FROM clientes$busca");
							...
							$result = $mysqli->query("SELECT COUNT(*) as Regs FROM clientes$busca");
