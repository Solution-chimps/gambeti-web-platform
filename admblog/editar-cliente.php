...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Editar Cliente<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e edite o cliente.</font></div>
        <br />
		<br />
        <form action="scripts/edt-cliente.php?id=<?=$id?>" method="post">
		...
		<a href='#' onClick="window.open('verFotoCliente.php?id=<?=$id?>','TrocarFoto','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=200,top=25,left=25'); return false;">alterar</a><br /><br />
        ...
        Link<br />
		<input type="text" name="link" class="configcampo" value="<?=$linkx?>"><br /><br />  
