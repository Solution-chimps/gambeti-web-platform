...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
	...
	<tr>
    	<td colspan="2" id="linhalogo" align="center"><a href="http://www.ueesp.org.br" target="_blank"><img src="default/logo.png" border="0" /></a></td>
	</tr>
    <tr>
    	<td id="linhamenu" valign="top"><?php require "menu.php"?></td>
    	<td align="left" valign="top" id="linhaconteudo">
        <div id="chamadapagina"><br />&nbsp;&nbsp;Tags<br /><font size="2">&nbsp;&nbsp;&nbsp;Gerenciamento de tags para notícias</font></div>
        Lista de Tags
        <br /><br /><br />
...
<table width="96%" border="0" cellpadding="0" cellspacing="0">
    <?php
			...
			echo"<td align=\"right\"><div style=\"width:150px\" class=\"btlaranja\" onclick=\"window.location='adicionar-tag.php';\">Adicionar Tag</div></td>";
...
<table class="tabelalistagem" width="96%" cellpadding="8" cellspacing="0" border="0">
	...
	<tr class="linhaindice">
    	<td class="celularindice" align="center" valign="middle">Nome Tag</td>      
...
if(($palavra=="")&&($dtinicio!="")){
	...
	$contador="0";
	$consulta= "SELECT *FROM tags$busca ORDER BY nome ASC LIMIT $inicio,$qpp";
	...
	while($linha=mysql_fetch_assoc($resultado))
	{
		...
		$valortotalos=$valortotalos+$total;
			...
			$btstatus="<div class=\"btcinza\" onclick=\"deletartag('$id')\">Deletar</div>";
...
echo"
	<tr class=\"linhacomumpar\">
		...
		<td class=\"celularcomum\" align=\"center\" valign=\"middle\" style=\"border-right:none;\" width=\"140\">$btstatus<div class=\"btcinza\" onclick=\"window.location='editar-tag.php?id=$id';\">Editar</div></td>
    </tr>
";			
		}
		else{
...
echo"
	<tr>
		<td colspan=\"4\" align=\"center\">Nenhuma tag encontrado... Cadastre no botão acima.</td>
	</tr>
";
	}
	else{
...
echo"
	<tr class=\"linhacomuimpar\">
    	<td class=\"celularcomum\" align=\"center\" valign=\"middle\" colspan=\"2\" style=\"border-right:none;height:2px;\"></td>
    </tr>
";			
	}
?>
...
//prepara o rodape
	...
	$consulta = mysql_query("SELECT COUNT(*) AS total FROM tags$busca");
...
//verifica total de anuncios na consulta solicitada
   $result = mysql_query("SELECT COUNT(*) as Regs FROM tags$busca");
...
<script>
	...
	function deletartag(id){
		var answer = confirm("Deseja mesmo deletar essa tag?")
		if (answer){
			window.location = "scripts/dltag.php?id="+id;
		}
		else{
		}
	}	
