...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Adicionar Tag<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e adicione essa tag.</font></div>
        <br />
		<br />
        <form action="scripts/cad-tag.php?id=<?=$id?>" method="post">
		...
		<input type="text" name="nome" class="configcampo" value="<?=$nome?>" /><br /><br />  
			...
			<br />  
        <p align="right">
	        <input type="submit" class="btlaranja" value="Adicionar Tag" />
        </p>
        </form>
