...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Adicionar Curso<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e adicione um curso ao site.</font></div>
        <br />
		<br />
        <form action="scripts/cad-curso.php" method="post" enctype="multipart/form-data">
		...
		<input type="text" name="datae" value="" class="configcampo"><br /><br />  

        Data Limite para Inscrição <a title="Essa data também será usada para ordenar o calendário">[?]</a><br />
		<input type="text" name="dtlimiteinscr" value="" class="configcampo"><br /><font size="1">dd/mm/aaaa</font><br /><br />                  
        
        Imagem de destaque<br />
		<input type="file" name="logo" class="configcampo"><br /><br />  
        


        Descrição<br />
		<textarea name="descricao" class="configtextomenor"></textarea><br /><br />                  
        
        
        Link de destino<br />
		<input type="text" name="destino" value="" class="configcampo"><br /><br />  
		...
		<input type="text" name="dtexpiracao" value="" class="configcampo"><br /><font size="1">dd/mm/aaaa</font><br /><br />          
        

        Senha<br />
		<input type="text" name="senha" value="" class="configcampo"><br /><br />  

        Valor<br />
		<input type="text" name="valor" id="valor" value="" class="configcampo"><br /><br />          
...
<fieldset>
	<legend>Dados impressos no certificado</legend>
        ...
        Duração<br />
		<input type="text" name="duracaocert" value="" class="configcampo"><br /><br />  
        
        Local<br />
		<input type="text" name="localcert" value="" class="configcampo"><br /><br />  

        Data<br />
		<input type="text" name="datacert" value="" class="configcampo"><br /><br />          
