...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Adicionar Cliente<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e adicione esse cliente.</font></div>
        <br />
		<br />
        <form action="scripts/cad-cliente.php" method="post" enctype="multipart/form-data">
        
        


        Logo<br />
		<input type="file" name="logo" class="configcampo"><br /><font size="1">Dimensão ideal: 119px x 108px</font><br /><br />  
        ...
        Link<br />
		<input type="text" name="link" value="" class="configcampo"><br /><br />  
