<?php
	...
	$id=$_GET["id"];	
$consulta= "SELECT *FROM tags WHERE id='$id'";
...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Editar Tag<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e edite essa tag.</font></div>
        <br />
		<br />
        <form action="scripts/edt-tag.php?id=<?=$id?>" method="post">
