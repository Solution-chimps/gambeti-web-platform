<?php
	...
	$id=$_GET["id"];	
$consulta= "SELECT *FROM destaques WHERE id='$id'";
...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Editar Destaque<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e edite o destaque da posição <?=$id?>.</font></div>
        <br />
		<br />
        <form action="scripts/edt-destaque.php?id=<?=$id?>" method="post">
        ...
        Imagem<br />
        <img src="../imagens/<?=$foto?>" class="fotoprincipal" /><br /><br />
		<a href='#' onClick="window.open('verFotoDestaque.php?id=<?=$id?>','TrocarFoto','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=200,top=25,left=25'); return false;">alterar</a><br /><br />
        
        Título<br />
        <input type="text" name="titulo" class="configcampo" value="<?=$titulo?>" /><br /><br />

        Subtítulo<br />
        <input type="text" name="subtitulo" class="configcampo" value="<?=$subtitulo?>" /><br /><br />

        Link<br />
        <input type="text" name="linkx" class="configcampo" value="<?=$linkx?>" /><br /><br />
