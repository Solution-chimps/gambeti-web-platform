...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Editar Notícia Programada<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e edite a notícia programada no site.</font></div>
        <br />
		<br />
        <form action="scripts/edt-noticia-programada.php?id=<?=$id?>" method="post">
		...
		<a href='../uploads/<?=$previewnoticia?>' style="color:#000;text-decoration:none" /><img src="default/ok.gif" border="0" align="Imagem Enviado com sucesso! Clique aqui para visualizar." /> <a href='#' onClick="window.open('verFotoPreviewProgramada.php?id=<?=$id?>','TrocarFotoElenco','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=200,top=25,left=25'); return false;">visualizar</a><br /><br />
