...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Adicionar Equipe<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e adicione essa pessoa a equipe.</font></div>
        <br />
		<br />
        <form action="scripts/cad-elenco.php" method="post" enctype="multipart/form-data">
        ...
        Cargo<br />
		<input type="text" name="departamento" value="" class="configcampo"><br /><br />  

        Contato<br />
		<input type="text" name="contato" value="" class="configcampo"><br /><br />  


        Sobre<br />
		<textarea name="sobre" class="configtexto"></textarea>  <br /><br />
        Missão<br />
		<textarea name="missao" class="configtexto"></textarea>  <br /><br />
