...
<table id="tbconteudo" border="0" height="800" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <div id="chamadapagina"><br />&nbsp;&nbsp;Adicionar Categoria<br /><font size="2">&nbsp;&nbsp;&nbsp;Preencha as informações abaixo e adicione essa categoria.</font></div>
        <br />
		<br />
        <form action="scripts/cad-categoria.php" method="post" enctype="multipart/form-data">
